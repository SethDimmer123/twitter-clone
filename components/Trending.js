...
export default function Trending() {
    return (
        <div className="hidden lg:flex flex-col ml-7 mt-4">
            ...
            w-[300px] h-[44px] p-0 rounded-3xl">
            ...
            <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
                ...
                <div className="p-3 relative">
                    ...
                    <p className="text-xs text-gray-500">570k Tweets</p>
                </div>
                <div className="p-3 relative">
                    <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
                    <p className="text-xs text-gray-500">Trending in US</p>
                ...
                <div className="p-3 relative">
                    ...
                    <p className="text-xs text-gray-500">550k Tweets</p>
                </div>
                <div className="p-3 relative">
                    <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
                    <p className="text-xs text-gray-500">Trending in US</p>
                    <h1 className="text-[15px] font-bold">Spider-man</h1>
                    <p className="text-xs text-gray-500">1k Tweets</p>
                </div>
                <div className="p-3 relative">
                    <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
                    <p className="text-xs text-gray-500">Trending in US</p>
                    <h1 className="text-[15px] font-bold">Batman</h1>
                    <p className="text-xs text-gray-500">1.1m Tweets</p>
                </div>
            </div>
            <div className="w-[300px] h-[300px] bg-white bg-opacity-10 rounded-3xl mt-3">
                ...
                <div className="flex justify-between p-3">
                    <div className="flex space-x-3">
                        <img className="w-11 h-11 object-cover rounded-full" src="/assets/pfp.png" />
                        <div>
                ...
                <div className="flex justify-between p-3">
                    <div className="flex space-x-3">
                        <img className="w-11 h-11 object-cover rounded-full" src="/assets/mrbeast.png" />
                        <div>
                            <div className="flex space-x-1 ">
                ...
                <div className="flex justify-between p-3">
                    <div className="flex space-x-3">
                        <img className="w-11 h-11 object-cover rounded-full" src="/assets/Billgates.png" />
                        <div>
                            <div className="flex space-x-1 ">
